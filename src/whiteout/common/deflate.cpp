...
///
/// The hand-rolled LZ77 + Huffman codec was replaced by zlib-ng (vendored at
/// externals/zlib-ng). zlib-ng is the single TU-local third-party dependency:
/// <zlib-ng.h> is pulled in here and nowhere else. The public surface
