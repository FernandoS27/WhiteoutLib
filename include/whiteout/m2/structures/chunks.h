...
/**
 * @brief Extended particle data v2 entry (EXP2)
 *
 * Extends EXPT with a per-particle alpha cutoff track indexed by the
 * particle's current lifetime position.
 */
struct EXP2Particle {
    f32 zSource = 0.0f;              ///< Z-axis source offset
 ...
 */
struct EXP2Chunk {
    std::vector<EXP2Particle> content; ///< Per-emitter extended particle data v2
};
