...
public:
     ...
     */
    Parser(ParseMode parseMode = ParseMode::Lenient, UpgradeMode upgradeMode = UpgradeMode::UpgradeOldVersions)
...
private:
    ...
    Material parseMaterial(BinaryReader& reader, u32 chunkSize, Model& mdx);  ///< Parse a single material
