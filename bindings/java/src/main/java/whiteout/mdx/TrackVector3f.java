...
public final class TrackVector3f implements AutoCloseable {
    ...
    /**
     * Raw keyframe data
     * @return the keys_data field of this MdxTrackVector3f.
     */
    public int getKeys_dataCount() {
        try { return (int) (long) Native.whiteout_mdx_MdxTrackVector3f_get_keys_data_count.invoke(handle); }
        catch (Throwable __ex) { throw new RuntimeException(__ex); }
    }
    public float[] getKeys_data() {
        try {
            long __count = (long) Native.whiteout_mdx_MdxTrackVector3f_get_keys_data_count.invoke(handle);
            MemorySegment __ptr = (MemorySegment) Native.whiteout_mdx_MdxTrackVector3f_get_keys_data_data.invoke(handle);
    ...
    public void setKeys_data(float[] values) {
        try (Arena arena = Arena.ofConfined()) {
            ...
            Native.whiteout_mdx_MdxTrackVector3f_assign_keys_data.invoke(handle, __seg, __count);
        } catch (Throwable __ex) { throw new RuntimeException(__ex); }
    }
    public void resizeKeys_data(int count) {
        try { Native.whiteout_mdx_MdxTrackVector3f_resize_keys_data.invoke(handle, (long) count); }
        catch (Throwable __ex) { throw new RuntimeException(__ex); }
    }
