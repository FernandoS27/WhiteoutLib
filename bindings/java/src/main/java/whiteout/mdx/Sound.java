...
public final class Sound implements AutoCloseable {
    ...
    public Sound() {
        try {
            MemorySegment __raw = (MemorySegment) Native.whiteout_mdx_MdxSound_new.invoke();
    ...
    public void close() {
        ...
        if (handle != null && !handle.equals(MemorySegment.NULL)) {
            try {
                Native.whiteout_mdx_MdxSound_delete.invoke(handle);
            } catch (Throwable __ex) { throw new RuntimeException(__ex); }
        }
    }
    ...
    public String getSoundFile() {
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment __s = (MemorySegment) Native.whiteout_mdx_MdxSound_get_soundFile.invoke(arena, handle);
    ...
    public void setSoundFile(String value) {
        try (Arena arena = Arena.ofConfined()) {
            ...
            Native.whiteout_mdx_MdxSound_set_soundFile.invoke(handle, __seg);
        } catch (Throwable __ex) { throw new RuntimeException(__ex); }
    }
    /**
