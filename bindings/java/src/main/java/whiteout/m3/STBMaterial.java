...
public final class STBMaterial implements AutoCloseable {
    ...
    public STBMaterial() {
        try {
            MemorySegment __raw = (MemorySegment) Native.whiteout_m3_M3STBMaterial_new.invoke();
    ...
    public void close() {
        ...
        if (handle != null && !handle.equals(MemorySegment.NULL)) {
            try {
                Native.whiteout_m3_M3STBMaterial_delete.invoke(handle);
            } catch (Throwable __ex) { throw new RuntimeException(__ex); }
        }
    }
    ...
    public String getName() {
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment __s = (MemorySegment) Native.whiteout_m3_M3STBMaterial_get_name.invoke(arena, handle);
    ...
    public void setName(String value) {
        try (Arena arena = Arena.ofConfined()) {
            ...
            Native.whiteout_m3_M3STBMaterial_set_name.invoke(handle, __seg);
        } catch (Throwable __ex) { throw new RuntimeException(__ex); }
    }
