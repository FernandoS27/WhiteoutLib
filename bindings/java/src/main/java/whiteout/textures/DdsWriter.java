...
public final class DdsWriter implements AutoCloseable {
    ...
    public DdsWriter() {
        try {
            MemorySegment __raw = (MemorySegment) Native.whiteout_textures_DdsWriter_new.invoke();
    ...
    public void close() {
        ...
        if (handle != null && !handle.equals(MemorySegment.NULL)) {
            try {
                Native.whiteout_textures_DdsWriter_delete.invoke(handle);
            } catch (Throwable __ex) { throw new RuntimeException(__ex); }
        }
    }
    ...
    public byte[] write(Texture texture) {
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment __struct = (MemorySegment) Native.whiteout_textures_DdsWriter_write.invoke(arena, handle, texture == null ? MemorySegment.NULL : texture.handle);
    ...
    public boolean hasIssues() {
        try {
        return ((int) Native.whiteout_textures_DdsWriter_hasIssues.invoke(handle)) != 0;
        } catch (Throwable __ex) { throw new RuntimeException(__ex); }
    }
