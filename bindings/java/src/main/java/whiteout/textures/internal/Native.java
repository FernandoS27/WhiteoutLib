...
public final class Native {
    ...
    public static final MethodHandle whiteout_textures_Texture_format = find(
        "whiteout_textures_Texture_format", FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
    public static final MethodHandle whiteout_textures_Texture_copyAsFormat = find(
        "whiteout_textures_Texture_copyAsFormat", FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_INT));
    public static final MethodHandle whiteout_textures_Texture_copyFromNormalToRGBA = find(
        "whiteout_textures_Texture_copyFromNormalToRGBA", FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
